import { computerArmy } from '../../../store/roster/army';
import { deleteNodeFromComputerNodes } from '..';
import { getRandomNode } from '../../../utils/node';
import { computerUnitsNodes, initializeComputerUnitsNodes } from '../nodes/computerNodes';
import { createUnit } from '../../../unit';

export const createComputerArmy = () => {
  initializeComputerUnitsNodes().then(
    () => {
